...
# history: list[dict[list[float]]] = [['weight_matrix', 'distance_matrix', 'accuracy', 'loss', 'val_accuracy', 'val_loss']]
# history.shape = (num_nets, 5, num_epochs)
...
# history.shape = (num_nets, num_epochs, num_nodes, num_local_statistics)
...
# history.shape = (num_nets, num_epochs, num_global_statistics)
